...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  <motion.div
    ...
    className={`relative ${
      active === id ? 'lg:flex-[3.5] flex-[25]' : 'lg:flex-[0.5] flex-[2]'
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 flex justify-start w-full flex-col rounded-b-[24px]">
        <div className={`${styles.flexCenter} w-[60px] h-[60px] rounded-[24px] glassmorphism mb-[16px]`}>
          <img src="https://ik.imagekit.io/5ok2lashts/headset.svg?updatedAt=1701773447937" alt="headset" className="w-1/2 h-1/2 object-contain" />
        </div>
